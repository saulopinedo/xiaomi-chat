...
/* harmony import */ var ngx_gravatar__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ngx-gravatar */ "./node_modules/ngx-gravatar/fesm2015/ngx-gravatar.js");
...
let HomeLayoutComponent = class HomeLayoutComponent {
    ...
    ngOnInit() {
        ...
        this.authService.emailFromUser.subscribe(email => {
            this.imageHash = email;
        });
    }
    onLogout() {
        this.authService.logout();
